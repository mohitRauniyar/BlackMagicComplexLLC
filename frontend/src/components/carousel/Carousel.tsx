...
const carouselItems: CarouselItemProps[] = [
  ...
  {
    title: "Clothing",
    description: "Men's, Women's, Children's clothing. Casual, Formal and Party Wears, all at one place.",
    buttonText: "Explore",
    modelColor: "#D946EF",
    modelType: "sphere",
  ...
  {
    title: "Footwear",
    description: "Get all types of footwear of different sizes and size formats for men, women and children.",
