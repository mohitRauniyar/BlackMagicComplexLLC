...
const HomePage = () => {
  ...
  useEffect(()=>{console.log(featuredProducts)}, [featuredProducts])
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-primary-300 max-w-2xl mx-auto">
              Discover our handpicked selection of premium fragrances that define elegance and sophistication
            </p>
          </div>
              ...
              >
                <Link to={`/products/${product._id}`}>
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-primary-400 mb-4 line-clamp-2">{product.description}</p>
                    
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-accent-500 font-semibold text-lg">${product.price.toFixed(2)}</p>
                        {product.oldPrice && (
      ...
      <section className="py-20 bg-primary-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Experience Luxury</h2>
